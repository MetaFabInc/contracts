...
describe('Game_Items_Exchange', () => {
  ...
  beforeEach(async () => {
    ...
    const Game_Items_Exchange = await ethers.getContractFactory('Game_Items_Exchange');
    ...
    exchangeContract = await Game_Items_Exchange.deploy(forwarderAddress);
  });
